...
class InlineStuffMod(loader.Module):
    ...
    strings = {
        ...
        "this_is_hikka": (
            "🥀 <b>Hi! This is Adaptator, UserBot that is based on the best UserBot Hikka. You can"
    ...
    strings_ru = {
        ...
        "this_is_hikka": (
            "🥀 <b>Привет! Это Adaptator, ЮзерБот основанный на Hikka. Вы можете"
    ...
    strings_uk = {
        ...
        "this_is_hikka": (
            "🥀 <b>Привіт! Це Adaptator, заснований на Hikka. Ви можете"

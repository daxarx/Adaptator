...
async def asset_channel(
    ...
    *,
    ...
    # legacy adaptator / hikka chats conversion to adaptator
    if title.startswith("hikka-"):
        title = title.replace("hikka-", "adaptator-")

    async for d in client.iter_dialogs():
        if (d.title == title) or ((d.title.replace("hikka-", "adaptator-") == title) if d.title.startswith("hikka-") else False):
    ...
    if _folder:
        ...
        _folder = "adaptator" if _folder == "hikka" else _folder
